...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="font-size: 14px; color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%;">To connect, please contact: <span style="color: #ffffff; line-height: 19.6px;"><a rel="noopener" href="mailto:${googleEmailConfig.email}?subject=Query%20regarding%20Activities%20Tracker" target="_blank" style="color: #ffffff;">${googleEmailConfig.email}</a></span></p>
  </div>
